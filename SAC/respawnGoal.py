...
class Respawn():
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        if self.stage != 4:
            ...
            while position_check:
                goal_position=[(12.6,28.7),(10.4,-27.6),(-14.0,26.2),(-16.3,-27.2)]
                goal =goal_position[random.randint(0,3)]
                self.goal_position.position.x =goal[0]
                self.goal_position.position.y = goal[1]
                position_check =False
